...
% Release Notes:
%   -   1.0.002     04/06/2021  Royi Avital
...
arguments
    mH (:, :) {mustBeFloat, mustBeReal}
    numRows (1, 1) {mustBeNumeric, mustBeReal, mustBePositive, mustBeInteger}
    numCols (1, 1) {mustBeNumeric, mustBeReal, mustBePositive, mustBeInteger}
    operationMode (1, 1) {mustBeNumeric, mustBeReal, mustBeMember(operationMode, [1, 2])} = 2
    boundaryMode (1, 1) {mustBeNumeric, mustBeReal, mustBeMember(boundaryMode, [1, 2, 3, 4])} = 3
end
