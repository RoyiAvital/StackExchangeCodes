...
mX1, vY1 = make_moons(n_samples = 200, noise = 0.075, random_state = seedNum)
mX2, vY2 = make_blobs(n_samples = 200, n_features = 2, centers = [[1.5, -1.0], [-0.5, 1.5]], cluster_std = [0.125, 0.195], random_state = seedNum)
