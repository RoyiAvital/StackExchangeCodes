...
% Remarks:
%   1.  In case the same convolution is applied on many images, stacking
...
%   2.  The output matrix has the form of doubly block Toeplitz matrix. The
...
%       *   Fixed issue with the creation of the sparse diagonal matrix.
